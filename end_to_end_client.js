...
var encrypted_text = pgpContext.encryptSign('test', [], keys, [], private_sign_key);
console.log(encrypted_text.result_);
var decrypted_text = pgpContext.verifyDecrypt(function(passphraseCallback){
    passphraseCallback(pass_phrase);
}, encrypted_text.result_);
...
keys = ctxApi.getEncryptKeys_([uid]);
console.log(keys);
